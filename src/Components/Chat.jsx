        ...
        return (   
            <>            
                <div className={classes.chat}>      
                    {history.map(element => 
                        <>                        
                            <div class="row" className={`${classes.rowUI} ${(userName === element.from ? classes.right : classes.left)}`}>                                               
                                <Typography className={(userName === element.from ? classes.messageConentRight : classes.messageConentLeft)} noWrap >
                                    {element.messageText}
                                </Typography>    
